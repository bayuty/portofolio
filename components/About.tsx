            ...
            <img
              ...
              onError={(e) => {
                ...
                if (parent) {
                  ...
                  parent.innerText =
                    'Foto tidak ditemukan. Pastikan file "bayu-profile.jpg" ada di folder root.';
                  parent.className =
                    "aspect-square rounded-2xl bg-panel/5 border-2 border-panel/10 relative z-10 flex items-center justify-center text-muted text-center p-6 text-xs font-mono";
                }
              }}
            />
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <h3 className="text-4xl font-display font-bold text-content mt-2">
              ...
              <span className="text-secondary">simple solutions</span>.
            </h3>
            <p className="text-muted leading-relaxed text-lg mt-4">{BIO}</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
            {[
              ...
              >
                <item.icon
                  className={`${item.color} mb-3 group-hover:scale-110 transition-transform`}
                />
                <h4 className="font-semibold text-content mb-1">
                  {item.title}
                </h4>
